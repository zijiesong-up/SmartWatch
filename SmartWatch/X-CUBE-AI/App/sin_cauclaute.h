/**
  ...
  ******************************************************************************
  */
#ifndef AI_SIN_CAUCLAUTE_H
#define AI_SIN_CAUCLAUTE_H

#include "sin_cauclaute_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SIN_CAUCLAUTE_MODEL_NAME          "sin_cauclaute"
#define AI_SIN_CAUCLAUTE_ORIGIN_MODEL_NAME   "sine_calcu"

/******************************************************************************/
#define AI_SIN_CAUCLAUTE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SIN_CAUCLAUTE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SIN_CAUCLAUTE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SIN_CAUCLAUTE_IN_NUM        (1)

AI_DEPRECATED
#define AI_SIN_CAUCLAUTE_IN \
  ai_sin_cauclaute_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SIN_CAUCLAUTE_IN_SIZE { \
  AI_SIN_CAUCLAUTE_IN_1_SIZE, \
}
#define AI_SIN_CAUCLAUTE_IN_SIZE_BYTES { \
  AI_SIN_CAUCLAUTE_IN_1_SIZE_BYTES, \
}
#define AI_SIN_CAUCLAUTE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SIN_CAUCLAUTE_IN_1_CHANNEL     (1)
#define AI_SIN_CAUCLAUTE_IN_1_SIZE        (1)
#define AI_SIN_CAUCLAUTE_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SIN_CAUCLAUTE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SIN_CAUCLAUTE_OUT \
  ai_sin_cauclaute_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SIN_CAUCLAUTE_OUT_SIZE { \
  AI_SIN_CAUCLAUTE_OUT_1_SIZE, \
}
#define AI_SIN_CAUCLAUTE_OUT_SIZE_BYTES { \
  AI_SIN_CAUCLAUTE_OUT_1_SIZE_BYTES, \
}
#define AI_SIN_CAUCLAUTE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SIN_CAUCLAUTE_OUT_1_CHANNEL     (1)
#define AI_SIN_CAUCLAUTE_OUT_1_SIZE        (1)
#define AI_SIN_CAUCLAUTE_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SIN_CAUCLAUTE_N_NODES (5)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup sin_cauclaute
 ...
 * @ref ai_sin_cauclaute_create. Both the activations memory buffer 
 ...
 * using @ref ai_sin_cauclaute_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sin_cauclaute_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sin_cauclaute_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SIN_CAUCLAUTE_*
 * defines into file @ref sin_cauclaute.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_sin_cauclaute_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SIN_CAUCLAUTE_H */
